...
public class CocktailScreen extends AppCompatActivity {
    ...
    void addFragment(){
        ...
        fragment = Whiskey.newInstance();
        fragmentList.add(fragment);

        fragment = Vodka.newInstance();
        fragmentList.add(fragment);

        fragment = Tequila.newInstance();
        fragmentList.add(fragment);

        fragment = Rum.newInstance();
        fragmentList.add(fragment);

        fragment = Gin.newInstance();
        fragmentList.add(fragment);

        fragment = Cider.newInstance();
        fragmentList.add(fragment);

        fragment = Brandy.newInstance();
        fragmentList.add(fragment);

        fragment = Beer.newInstance();
        fragmentList.add(fragment);
